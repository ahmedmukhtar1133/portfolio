                                        ...
                                        <Box>
                                            ...
                                            <Box py={{ base: 5, sm: 5, md: 8, lg: 10 }}>
                                                <VStack pl={0} spacing={3} alignItems="flex-start">
                                                    <Link href='tel:+923015045747' passHref>
                                                        <Button
                                                            as={ChakraLink}
                                                            size="md"
                                                            height="48px"
                                                    ...
                                                    <Link href='mailto: ahmedmukhtar1133@gmail.com' passHref>
                                                        <Button
                                                            as={ChakraLink}
                                                            size="md"
                                                            height="48px"
                                                            ...
                                                            <FormControl id="email" isInvalid={errors.email} mt={2}>
                                                                ...
                                                                <InputGroup borderColor="#E0E1E7">
                                                                    ...
                                                                    <Input type="email" size="md" name="email"
                                                                        placeholder="ahmedmukhtar1133@gmail.com"
                                                                        {...register('email', {
